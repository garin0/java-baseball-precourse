...
public class Message {
    ...
    public final static String GAME_WIN = BaseBallAnswerGenerator.BASEBALL_SIZE + "개의 숫자를 모두 맞히셨습니다! 게임 종료";
    ...
    public final static String ERROR_INPUT_COUNT = BaseBallAnswerGenerator.BASEBALL_SIZE + "자리로 입력해주세요.";
}
